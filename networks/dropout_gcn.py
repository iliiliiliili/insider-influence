...
from networks.dropout_gcn_layers import DropoutBatchGraphConvolution


class DropoutBatchGCN(nn.Module):
    def __init__(
        self,
        n_units,
        fine_tune=False,
        ...
        super(DropoutBatchGCN, self).__init__()
